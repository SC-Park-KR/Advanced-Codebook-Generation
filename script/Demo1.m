...
t = toc;
disp(['Generate a VQ codebook with a codebook size of ', num2str(Q)])
...
t = toc;
disp(['Generate a DFT codebook with a codebook size of ', num2str(Q)])
...
initial_codebook_sph(2, ind_rem)    = 0;
...
t = toc;
disp(['Generate an enhanced codebook with a codebook size of ', num2str(Q), ' from the generated DFT codebook'])
